  ...
  return (
    <Menu as="div" className="relative hidden lg:inline-block text-left">
      ...
      <Transition
        ...
        <Menu.Items className="absolute w-[512px] bg-white dark:bg-gray-800 shadow-lg divide-y divide-slate-100 rounded-md ring-1 ring-black ring-opacity-5 focus:outline-none left-0 origin-top-left">
          <List1 />
        </Menu.Items>
      </Transition>
    </Menu>
