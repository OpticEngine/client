    ...
    <>
      <div className="mb-4 grid grid-cols-2 gap-y-2 gap-x-2 lg:hidden">
        ...
        <div className="sm:col-span-1 place-self-end">
          ...
          <select
            name="select"
            className="block w-40 bg-white border-slate-300 dark:bg-gray-800 dark:border-slate-700 form-select focus:ring-blue-500 focus:border-blue-500 focus:ring-0 sm:text-sm rounded-md">
      ...
      <div className="hidden mb-4 lg:items-center lg:grid lg:gap-x-2 lg:grid-cols-12">
        ...
        <div className="sm:col-span-5">
          <div className="flex flex-row items-center justify-end space-x-2">
            ...
            <select
              name="select"
              className="block bg-white border-slate-300 w-40 dark:bg-gray-800 dark:border-slate-700 form-select focus:ring-blue-500 focus:border-blue-500 focus:ring-0 sm:text-sm rounded-md">
              <option value="">Select</option>
              {options.map((option) => (
                <option key={option.key} value={option.key}>
                  {option.value}
